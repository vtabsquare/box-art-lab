...
const getBackgroundImage = (productName: string) => {
  ...
  const mapping: Record<string, string> = {
    ...
    'Chocolate Box': '/images/chocolate-box.jpeg',
    'Cup Cake Box': '/images/cupcake-box.webp',
    'Cookies Box': '/images/cookies-box.webp',
    'Dosa Box': '/images/dosa-box.jpeg',
    'Dip Tea Box': '/images/diptea-box.webp',
    'Dates Box': '/images/dates-box.webp',
    'Fried Chicken Box': '/images/fried-chicken-box.jpeg',
    ...
    'Nuts & Spices Box': '/images/nuts-and-spices-box.jpeg',
    'Nuggets Box': '/images/nuggets-box.jpg',
    'Pastries Box': '/images/pastries-box.webp',
    'Plum Cake Box': '/images/plumcake-box.jpeg',
    ...
    'Saree Box': '/images/saree-box.webp',
    'Jacket Box': '/images/jacket-box.jpeg',
    'Trouser Box': '/images/trouser-box.jpeg',
    'Lingerie Box': '/images/lingerie-box.webp',
    'Sports Wear Box': '/images/sports-wear-box.jpeg',
    'Accessories Box': '/images/accessories-box.jpg',
    'Hat Box': '/images/hat-box.jpg',
    // ─── Carriable ───
    ...
    'Festival Gift Box': '/images/festival-gift-box.png',
    'Luxury Bag': '/images/luxury-bag.webp',
    ...
    'Smartwatch Box': '/images/smartwatch-box.jpg',
    'Charger Box': '/images/charger-box.png',
    'Camera Box': '/images/camera-box.jpeg',
    'Tablet Box': '/images/tablet-box.jpg',
    'Router / IoT Box': '/images/router-box.webp',
    'Gaming Peripheral Box': '/images/gaming-box.jpeg',
    // ─── Pouches ───
    ...
    'Kraft Paper Pouch': '/images/kraft-paper-pouch.webp',
    // ─── E-Commerce ───
    ...
    'Fragile Item Box': '/images/fragileitem-box.jpeg',
    'Book Mailer': '/images/book-mailer-box.jpg',
    'Tube / Cylinder Mailer': '/images/cylinder-mailer-box.jpg',
    // ─── Pharma ───
    'Medicine Box': '/images/medicine-box.jpeg',
    'Supplement Box': '/images/supplement-box.jpeg',
    'Syrup / Drop Box': '/images/syrup-drop-box.jpeg',
    'Tablet Strip Box': '/images/tablet-strip-box.jpg',
    'Injection Vial Box': '/images/injection-vial_box.jpeg',
    ...
    'Medical Device Box': '/images/medical-device-box.webp',
    // ─── Cosmetic ───
    'Perfume Box': '/images/perfume-box.jpeg',
    'Cosmetic Box': '/images/cosmetic-box.jpeg',
    'Serum Box': '/images/serum-box.jpeg',
    'Foundation Box': '/images/foundation-box.webp',
    'Eye Shadow Palette Box': '/images/eye-shadow-palette-box.webp',
    'Nail Polish Box': '/images/nail-polish.webp',
    'Hair Care Box': '/images/hair-care-box.jpeg',
    'Skincare Set Box': '/images/skincare-set-box.jpg',
    'Lipstick Box': '/images/lipstick-box.jpeg',
    'Body Lotion Box': '/images/body-lotion.jpeg',
    // ─── Luxury ───
    ...
    'Luxury Scarf Box': '/images/scarf-box.webp',
