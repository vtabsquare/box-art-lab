...
export const productTypes: ProductType[] = [
  ...
  { id: 'biriyani-box', name: 'Biriyani Box', category: 'food', description: 'Sturdy takeaway biriyani container', icon: '🍲', defaultDimensions: { length: 15, width: 15, height: 8 } },
  ...
  { id: 'cheese-box', name: 'Cheese Box', category: 'food', description: 'Premium cheese wedge/wheel box', icon: '🧀', defaultDimensions: { length: 10, width: 10, height: 4 } },
  ...
  { id: 'fancy-tea-box', name: 'Fancy Tea Box', category: 'food', description: 'Premium tea packaging', icon: '🍵', defaultDimensions: { length: 20, width: 15, height: 8 } },
  ...
  { id: 'instant-food-box', name: 'Instant Food Box', category: 'food', description: 'Noodle or instant meal cup/box', icon: '🍜', defaultDimensions: { length: 10, width: 10, height: 12 } },
  ...
  { id: 'nuts-spices-box', name: 'Nuts & Spices Box', category: 'food', description: 'Windowed box for dry fruits', icon: '🥜', defaultDimensions: { length: 15, width: 10, height: 5 } },
  ...
  { id: 'plum-cake-box', name: 'Plum Cake Box', category: 'food', description: 'Festive plum cake tin or box', icon: '🥮', defaultDimensions: { length: 20, width: 10, height: 8 } },
  ...
  { id: 'savouries-box', name: 'Savouries Box', category: 'food', description: 'Box for traditional snacks', icon: '🥨', defaultDimensions: { length: 20, width: 15, height: 8 } },
  ...
  { id: 'tea-box', name: 'Tea Box', category: 'food', description: 'Loose leaf tea carton', icon: '☕', defaultDimensions: { length: 10, width: 10, height: 12 } },
  { id: 'triangular-cake-slice-box', name: 'Triangular Cake Slice Box', category: 'food', description: 'Individual cake slice container', icon: '🍰', defaultDimensions: { length: 12, width: 10, height: 8 } },
  // Garment
  ...
  { id: 'jacket-box', name: 'Jacket Box', category: 'garment', description: 'Large rigid box for jackets & coats', icon: '🧥', defaultDimensions: { length: 50, width: 38, height: 8 } },
  ...
  { id: 'lingerie-box', name: 'Lingerie Box', category: 'garment', description: 'Delicate innerwear gift packaging', icon: '🎀', defaultDimensions: { length: 28, width: 20, height: 6 } },
  ...
  { id: 'hat-box', name: 'Hat Box', category: 'garment', description: 'Round or square cap & hat packaging', icon: '🎩', defaultDimensions: { length: 35, width: 35, height: 20 } },
  // Carriable
  { id: 'carrier-bag', name: 'Carrier Bag', category: 'carriable', description: 'Handled carry packaging', icon: '🛍️', defaultDimensions: { length: 25, width: 12, height: 30 } },
  ...
  { id: 'festival-box', name: 'Festival Gift Box', category: 'carriable', description: 'Decorative seasonal & festival packaging', icon: '🪔', defaultDimensions: { length: 30, width: 22, height: 12 } },
  ...
  { id: 'gadget-box', name: 'Gadget Box', category: 'electronics', description: 'Electronics & accessories packaging', icon: '🎧', defaultDimensions: { length: 22, width: 18, height: 10 } },
  ...
  { id: 'earbuds-box', name: 'Earbuds Box', category: 'electronics', description: 'Compact packaging for wireless earbuds', icon: '🎵', defaultDimensions: { length: 10, width: 10, height: 5 } },
  ...
  // Pouches
  { id: 'stand-pouch', name: 'Stand-Up Pouch', category: 'pouches', description: 'Flexible stand-up pouch packaging', icon: '🧴', defaultDimensions: { length: 14, width: 6, height: 22 } },
  ...
  { id: 'fragile-box', name: 'Fragile Item Box', category: 'ecommerce', description: 'Double-wall box with foam inserts', icon: '⚠️', defaultDimensions: { length: 25, width: 20, height: 18 } },
  { id: 'book-mailer', name: 'Book Mailer', category: 'ecommerce', description: 'Flat rigid mailer for books & documents', icon: '📚', defaultDimensions: { length: 35, width: 25, height: 4 } },
  ...
  { id: 'hair-care-box', name: 'Hair Care Box', category: 'cosmetic', description: 'Box for shampoo, conditioner & oils', icon: '💇', defaultDimensions: { length: 10, width: 8, height: 22 } },
  ...
  { id: 'body-lotion-box', name: 'Body Lotion Box', category: 'cosmetic', description: 'Wide box for lotion & body butter jars', icon: '🛁', defaultDimensions: { length: 10, width: 10, height: 10 } },
  // Luxury
  ...
  { id: 'scarf-box', name: 'Luxury Scarf Box', category: 'luxury', description: 'Flat rigid box for scarves & silk ties', icon: '🧣', defaultDimensions: { length: 32, width: 28, height: 5 } },
